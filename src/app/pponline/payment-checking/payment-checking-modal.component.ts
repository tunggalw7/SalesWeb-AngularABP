...
@Component({
    selector: 'paymentCheckingModal',
    templateUrl: './payment-checking-modal.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['./payment-checking.component.css']

})
export class PaymentCheckingModalComponent extends AppComponentBase {
    ...
    createPayment() {
        ...
        this._transactionServiceProxy.inputPaymentOffline(this.createPaymentData)
