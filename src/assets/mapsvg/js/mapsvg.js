        ...
        this.methods = {
            ...
            setTooltips : function (options) {
                ...
                $('body').off(event).on(event, function(e) {
                    ...
                    let topCustom; let leftCustom;
                    topCustom = window.scrollY - 150 + 80 +'px';
                    if (e.screenX > 1240 || e.screenX > 936) leftCustom = (e.pageX - 520) + 'px';
                    else leftCustom = (e.pageX + 20) +'px';

                    _data.tooltip.container[0].style.left = leftCustom;
                    ...
                    // console.log("LEFT : ", _data.tooltip.container[0].style.left);
                    // console.log("TOP : ", _data.tooltip.container[0].style.top);
